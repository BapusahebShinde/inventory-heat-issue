...
/**
 * The Store Outward scan adapter.
 */
public class StoreOutwardScanAdapter extends RecyclerView.Adapter<StoreOutwardScanAdapter.ViewHolder>{
   ...
   */
  public StoreOutwardScanAdapter(@NonNull MainActivity context, @NonNull CommonFragment frag, List<TripInventory> listMenus){
