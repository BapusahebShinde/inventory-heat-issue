 ...
 */
public class StoreOutwardHuDetailsAdapter extends RecyclerView.Adapter<StoreOutwardHuDetailsAdapter.ViewHolder>{
   ...
   */
  public StoreOutwardHuDetailsAdapter(@NonNull MainActivity context, @NonNull CommonFragment frag, List<TripInventory> listMenus){
  ...
  public void onBindViewHolder(@NonNull ViewHolder holder, int position){
    ...
    holder.itemView.setOnClickListener(v -> {
      ...
      else if(itemModel.status.equalsIgnoreCase("P")){
        Bundle arg = chkNull(frag.getArguments(), new Bundle());
        arg.putSerializable(itemModel.getClass().getSimpleName(), (Serializable) itemModel);
        arg.putString(AppConstants.TRIP_NUMBER, itemModel.tripNo);
        arg.putString(AppConstants.HU_NUMBER, itemModel.huNo);
