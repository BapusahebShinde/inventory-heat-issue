...
public class AgeingStartViewPagerAdapter extends FragmentStateAdapter{
   ...
   * @param tabs     the tabs
   */
  public AgeingStartViewPagerAdapter(@NonNull CommonFragment fragment, List<String> tabs){
    super(fragment);
    this.frag = fragment;
    this.tabs = tabs;
  }
   ...
   * @param tabs     the tabs
   */
  public AgeingStartViewPagerAdapter(@NonNull CommonFragment fragment, final List<String> tabs, final JSONObject jsonObject, final String omniType){
    super(fragment);
    this.frag = fragment;
    this.tabs = tabs;
