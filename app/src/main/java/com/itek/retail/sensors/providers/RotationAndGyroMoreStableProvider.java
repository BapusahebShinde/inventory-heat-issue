...
public class RotationAndGyroMoreStableProvider extends OrientationProvider{
...
/**
  ...
  */
/**
   * Initialises a new RotationAndGyroMoreStableProvider
   *
   * @param sensorManager The android sensor manager
   *//*

  public RotationAndGyroMoreStableProvider(SensorManager sensorManager){
    super(sensorManager);
    Log.e("SENSOR", "IN RotationAndGyroMoreStableProvider");
  ...
  public void onSensorChanged(SensorEvent event){
    ...
    if(event.sensor.getType() == Sensor.TYPE_ROTATION_VECTOR){
      Log.e("SENSORTYPE1", "TYPE_ROTATION_VECTOR");
      ...
      // Log.e("SENSORTYPE2","TYPE_GYROSCOPE");
...
/**
  ...
  private void setOrientationQuaternionAndMatrix(Quaternion quaternion){
    ...
    synchronized(synchronizationToken){
      ...
      if(quaternion.getX() != 0 && currentAngle < 180){
        double diff = currentAngle - oldAngle;
        diff = Math.abs(diff);
        // if(diff<90 || oldAngle==0.0){
