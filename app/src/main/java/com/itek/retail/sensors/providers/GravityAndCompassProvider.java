 ...
 *
 */
public class GravityAndCompassProvider extends OrientationProvider {
     ...
     */
    public GravityAndCompassProvider(SensorManager sensorManager) {
        super(sensorManager);
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if (magnitudeValues != null && gravityValues != null) {
            ...
            SensorManager.getRotationMatrix(currentOrientationRotationMatrix.matrix, null, gravityValues, magnitudeValues);
