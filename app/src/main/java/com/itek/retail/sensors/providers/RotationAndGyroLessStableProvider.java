...
public class RotationAndGyroLessStableProvider extends OrientationProvider {
...
/**
    ...
    */
/**
     * Initialises a new RotationAndGyroLessStableProvider
     *
     * @param sensorManager The android sensor manager
     *//*

    public RotationAndGyroLessStableProvider(SensorManager sensorManager) {
        super(sensorManager);
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if (event.sensor.getType() == Sensor.TYPE_ROTATION_VECTOR) {
            ...
            Log.e("X-VALUE",""+temporaryQuaternion[1]);
