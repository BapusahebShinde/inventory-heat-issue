...
public class AccelerometerGyroAndCompassCalibratedGyroProvider extends OrientationProvider {
...
/**
    ...
    */
/**
     * Initialises a new AccelerometerGyroAndCompassCalibratedGyroProvider
     *
     * @param sensorManager The android sensor manager
     *//*

    public AccelerometerGyroAndCompassCalibratedGyroProvider(SensorManager sensorManager) {
        super(sensorManager);
