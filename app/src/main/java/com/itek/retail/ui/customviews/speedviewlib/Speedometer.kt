...
import com.itek.retail.ui.customviews.speedviewlib.components.indicators.Indicator
import com.itek.retail.ui.customviews.speedviewlib.components.indicators.NoIndicator
import com.itek.retail.ui.customviews.speedviewlib.components.note.Note
import com.itek.retail.ui.customviews.speedviewlib.util.OnPrintTickLabelListener
...
abstract class Speedometer @JvmOverloads constructor(
   ...
   */
  var indicatorLightColor = 0xFF3A3A3A.toInt()
  ...
  private fun initAttributeSet(context: Context, attrs: AttributeSet?) {
    ...
    val ind =
      a.getInt(R.styleable.Speedometer_sv_indicator, Indicator.Indicators.SpindleIndicator.ordinal)
    if (ind != -1) {
      setIndicator(Indicator.Indicators.values()[ind])
      indicator.width = context.resources.getDimension(R.dimen.dp_10)
    ...
    showLog("markWidth", "" + markWidth);
    markColor =
      a.getColor(R.styleable.Speedometer_sv_markColor, ContextCompat.getColor(context, R.color.red))
    val markStyleIndex = a.getInt(R.styleable.Speedometer_sv_markStyle, -1)
    if (markStyleIndex != -1) markStyle = Style.values()[markStyleIndex]
    backgroundCircleColor = a.getColor(
      R.styleable.Speedometer_sv_backgroundCircleColor,
