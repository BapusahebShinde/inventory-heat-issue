...
import com.itek.retail.ui.customviews.speedviewlib.components.indicators.TriangleIndicator
...
open class AwesomeSpeedometer @JvmOverloads constructor(
  ...
  private fun initAttributeSet(context: Context, attrs: AttributeSet?) {
    ...
    speedometerColor =
      a.getColor(R.styleable.AwesomeSpeedometer_sv_speedometerColor, speedometerColor)
    trianglesPaint.color =
      a.getColor(R.styleable.AwesomeSpeedometer_sv_trianglesColor, trianglesPaint.color)
    a.recycle()
  }
  ...
  private fun updateGradient() {
    ...
    val radialGradient = RadialGradient(
      ...
      sizePa * .5f,
      colors,
      floatArrayOf(stop, stop2, stop3, stop4, stop5, 1f),
