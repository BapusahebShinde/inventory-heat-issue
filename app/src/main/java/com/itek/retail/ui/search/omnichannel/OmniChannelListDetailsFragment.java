...
/**
 * The Omni channel list details fragment.
 */
public class OmniChannelListDetailsFragment extends CommonFragment{
  
  final AppCommonMethods.SessionType sessionType = AppCommonMethods.SessionType.OMNICHANNEL;
  ...
  boolean isAllowDecodeOnPick = false;
  boolean isAllowDecodeWithoutVerify = false;
   ...
   */
  public OmniChannelListDetailsFragment(){/*Default/Empty Constructor*/}
  ...
  public void onBackPressed(){
    ...
    context.showCustomAlertDialog("_", found > 0 /*&& total > 0*/ && required > 0 ? String.format(getString(R.string.msg_omni_back_3), found + "/" + required/*total*/, omniType.toLowerCase()) : String.format(getString(R.string.msg_omni_back_1), SharedPrefManager.getString(isEANSearch?ParamConstants.LABEL_EANS:ParamConstants.LABEL_ORDER,context.getString(isEANSearch?R.string.lbl_ean:R.string.lbl_order))), R.string.btn_no, new DialogInterface.OnClickListener(){
      @Override
      public void onClick(DialogInterface dialogInterface, int i){
  ...
  public void updateLists(){
   ...
   // binding.txtOmnichannelOrdernoEan.setText(HtmlCompat.fromHtml(String.format(getString(R.string.txt_order_no_qty), selProd.getOrderNo(), "" + found, "" + required), HtmlCompat.FROM_HTML_MODE_LEGACY));
    ...
    binding.txtOmnichannelOrdernoEan.setText(HtmlCompat.fromHtml(String.format(getString(R.string.txt___qty),SharedPrefManager.getString(isEANSearch?ParamConstants.LABEL_EANS:ParamConstants.LABEL_ORDER, context.getString(isEANSearch?R.string.lbl_ean:R.string.lbl_order)), selProd.getOrderNo(), "" + found, "" + required), HtmlCompat.FROM_HTML_MODE_LEGACY));
