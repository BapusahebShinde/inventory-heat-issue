 ...
 */
public class TripsDashboardFragment extends CommonFragment{
  
  private InOutWardPhase1ViewModel mViewModel;
   ...
   */
  public TripsDashboardFragment(){/*Default/Empty Constructor*/}
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
    mViewModel = new ViewModelProvider(this, (ViewModelProvider.Factory) new ViewModelProvider.NewInstanceFactory()).get(InOutWardPhase1ViewModel.class);
