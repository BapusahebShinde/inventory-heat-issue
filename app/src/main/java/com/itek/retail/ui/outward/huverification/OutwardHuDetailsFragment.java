...
import com.itek.retail.adapter.StoreOutwardHuDetailsAdapter;
...
import com.itek.retail.databinding.FragmentOutwardHuDetailsBinding;
...
/**
 * The Outward trip details fragment.
 */
public class OutwardHuDetailsFragment extends CommonFragment{
  ...
  private FragmentOutwardHuDetailsBinding binding;
  
  /**
   * Instantiates a new Outward trip details fragment.
   */
  public OutwardHuDetailsFragment(){/*Default/Empty Constructor*/}
  ...
  public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState){
    ...
    binding = FragmentOutwardHuDetailsBinding.inflate(inflater, container, false);
    ...
    if(getArguments() != null){
      ...
      binding.txtTripUpload.setVisibility(View.GONE);
    ...
    binding.imgStart.setOnClickListener(v -> {
      ...
      context.loadFragment(new OutwardHuStartFragment(), arg);
    });
    ...
    binding.listTripDetails.setAdapter(new StoreOutwardHuDetailsAdapter((MainActivity) context, OutwardHuDetailsFragment.this, dataList));
  ...
  public void updateLists(){
    ...
    if(tripInventoryDao.getHuComplete(tripNo)){
      tripStatusDao.updateCompleteTripStatus(tripNo, AppConstants.OUTWARD);
      popBackStack();
    }
  ...
  public void showTripInprogressConfirmDialog(final String msg){
    context.showCustomAlertDialog("", msg + "\n" + getString(R.string.msg_inprogess_trip_alert), R.string.btn_yes, (dialog, which) -> {
      tripStatusDao.updateInProgressTripStatus(tripNo, AppConstants.OUTWARD);
      popBackStack();
    }, R.string.btn_no, (dialog, which) -> dialog.dismiss());
  }
}