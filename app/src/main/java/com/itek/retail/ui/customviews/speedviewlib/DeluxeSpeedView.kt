...
import com.itek.retail.ui.customviews.speedviewlib.components.indicators.NormalSmallIndicator
...
open class DeluxeSpeedView @JvmOverloads constructor(
  ...
  private fun initAttributeSet(context: Context, attrs: AttributeSet?) {
    ...
    speedBackgroundPaint.color =
      a.getColor(R.styleable.DeluxeSpeedView_sv_speedBackgroundColor, speedBackgroundPaint.color)
